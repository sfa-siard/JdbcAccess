  ...
  implements Driver
{
  ...
  static String getVersion() { return sVERSION; }
  ...
  public static void register() 
  {
    ...
    try { DriverManager.registerDriver(new AccessDriver()); }
    catch (SQLException se) { System.err.println("Registering of "+AccessDriver.class.getName()+" with DriverManager failed!"); }
  } /* register */
  ...
  {
    boolean bAcceptsUrl = false;
    if (getDatabaseName(sUrl) != null)
      bAcceptsUrl = true;
    return bAcceptsUrl;
  } /* acceptsUrl */
