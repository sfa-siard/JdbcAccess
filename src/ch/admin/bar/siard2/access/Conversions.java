...
public abstract class Conversions
{
  ...
  private static <T> T get(Object oSource, String sMethod, Class<T> clsResult)
  {
    ...
    catch(NoSuchMethodException nsme) { throw new IllegalArgumentException(nsme.getClass().getName()+": "+nsme.getMessage()); }
    ...
    if (oSource != null)
    {
      ...
      if (b == null)
        throw new IllegalArgumentException("Object of type " + 
          oSource.getClass().getName()+" cannot be converted to " + 
  ...
  public static String getString(Object oSource)
  {
    ...
    if (oSource != null)
    {
      ...
      else if (oSource instanceof NClob)
      {
        ...
        try { s = nclob.getSubString(1l, (int)nclob.length()); }
        catch(SQLException se) { throw new IllegalArgumentException("String of NClob could not be retrieved!"); }
      }
      else if (oSource instanceof Clob)
      {
        Clob clob = (Clob)oSource;
        try { s = clob.getSubString(1l, (int)clob.length()); }
        catch(SQLException se) { throw new IllegalArgumentException("String of Clob could not be retrieved!"); }
      }
      else if (oSource instanceof SQLXML)
      {
        SQLXML sqlxml = (SQLXML)oSource;
        try { s = sqlxml.getString(); }
        catch(SQLException se) { throw new IllegalArgumentException("String of SQLXML could not be retrieved!"); }
      }
    }
    return s;
  } /* getString */
  ...
  public static java.sql.Date getDate(Object oSource)
  {
    ...
    if (oSource != null)
    {
      ...
      else if (oSource instanceof String)
      {
        ...
        try { date = java.sql.Date.valueOf(s); }
        catch (IllegalArgumentException iae) {}
        /* else try to parse it */
        try { date = new java.sql.Date(java.util.Date.parse(s)); }
        catch (IllegalArgumentException iae) {}
      }
  ...
  public static java.sql.Time getTime(Object oSource)
  {
    ...
    if (oSource != null)
    {
      ...
      else if (oSource instanceof String)
      {
        ...
        String s = (String)oSource;
        try { time = java.sql.Time.valueOf(s); }
        catch (IllegalArgumentException iae) {}
        /* else try to parse it */
        try { time = new java.sql.Time(java.util.Date.parse(s)); }
        catch (IllegalArgumentException iae) {}
      }
      else if (oSource instanceof java.util.Date)
      {
  ...
  public static java.sql.Timestamp getTimestamp(Object oSource)
  {
    ...
    if (oSource != null)
    {
      ...
      else if (oSource instanceof String)
      {
        ...
        String s = (String)oSource;
        try { ts = java.sql.Timestamp.valueOf(s); }
        catch (IllegalArgumentException iae) {}
        /* else try to parse it */
        try { ts = new java.sql.Timestamp(java.util.Date.parse(s)); }
        catch (IllegalArgumentException iae) {}
      }
      else if (oSource instanceof java.util.Date)
      {
      ...
      else if (oSource instanceof Calendar)
      {
        /* if it is a java.util.Calendar, just use the milliseconds */
        Calendar c = (Calendar)oSource;
        ts = new java.sql.Timestamp(c.getTime().getTime());
      }
      else
      {
        /* if it is a long, use them as milliseconds */
    ...
    if (oSource != null)
    {
      if (oSource instanceof BigDecimal)
      {
        ...
        else if (bd.scale() == 9)
        {
          ...
          BigDecimal[] abd = bd.divideAndRemainder(bdDivisor);
          long lNanoseconds = abd[1].unscaledValue().longValue();
  ...
  public static byte[] getBytes(Object oSource)
  {
    ...
    if (oSource != null)
    {
      ...
      else if (oSource instanceof Blob)
      {
        ...
        try { buffer = blob.getBytes(1l, (int)blob.length()); }
        catch(SQLException se) { throw new IllegalArgumentException("Bytes of Blob could not be retrieved!"); }
      }
    ...
    throws java.sql.SQLException
  {
    ...
    if (oSource != null)
    {
      ...
      else
      {
        ...
        {
          try { url = new URL(s); }
          catch(MalformedURLException mfu) { throw new java.sql.SQLException(mfu.getClass().getName()+": "+mfu.getMessage()); }
        }
      }
    }
    return url;
